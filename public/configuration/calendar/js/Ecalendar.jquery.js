$.fn.ECalendar = function(config){
        ...
        function setData(date)
        {
            ...
            //day3.children('li.active').removeClass('active').siblings('li[data='+getDate+']').addClass('active');
            //获取当前时间的时间差
            var now = new Date();
