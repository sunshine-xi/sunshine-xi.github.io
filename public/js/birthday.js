...
//加入购物车切换重量功能
    ...
    //$(".bth-ok").on("click",function(){
    //    var Totalsum=$(this).parent().parent().find("span").text() ;
    //    console.log(Totalsum);
    //    var gouwu=$(this).parent();
    //    var pongs=$(this).parent().parent().prev();
    //    //var goodsTittle=$(this).parent().parent().parent().prev().prev().prev().prev().prev().text();
    //    //console.log(goodsTittle);
    //    var productid=$(this).parent().parent().parent().parent().parent().find(".text-center").find("img").attr("src");
    ...
    $.ajax({
        ...
        success:function(data){
            if(data==""){
                ...
                //var pongs=$(obj).parent().parent().prev();
